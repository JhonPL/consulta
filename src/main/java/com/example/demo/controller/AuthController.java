...
public class AuthController {
    ...
    public ResponseEntity<?> register(@RequestBody Usuario usuario) {
        // en producción validar DTO, chequear duplicados, etc.
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest request) {
        ...
        // Buscar usuario por correo (sencillo y funcional)
        ...
        LoginResponse resp = new LoginResponse(token, roleName, u.getNombreCompleto());
